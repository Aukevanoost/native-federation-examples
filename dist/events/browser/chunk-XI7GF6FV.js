// projects/events/src/app/app.component.ts
...
var _c4 = () => ({ title: "Angular\n        DevTools", link: "https://angular.dev/tools/devtools" });
var _c5 = (a0, a1, a2, a3, a4) => [a0, a1, a2, a3, a4];
var _forTrack0 = ($index, $item) => $item.title;
function AppComponent_For_27_Template(rf, ctx) {
  if (rf & 1) {
    i0.\u0275\u0275domElementStart(0, "a", 21)(1, "span");
    i0.\u0275\u0275text(2);
    i0.\u0275\u0275domElementEnd();
    i0.\u0275\u0275namespaceSVG();
    i0.\u0275\u0275domElementStart(3, "svg", 33);
    i0.\u0275\u0275domElement(4, "path", 34);
    i0.\u0275\u0275domElementEnd()();
  }
  if (rf & 2) {
    const item_r1 = ctx.$implicit;
    i0.\u0275\u0275domProperty("href", item_r1.link, i0.\u0275\u0275sanitizeUrl);
    i0.\u0275\u0275advance(2);
    i0.\u0275\u0275textInterpolate(item_r1.title);
  }
}
var AppComponent = class _AppComponent {
  title = signal("Events micro frontend", ...ngDevMode ? [{ debugName: "title" }] : []);
  clickCount = signal(0, ...ngDevMode ? [{ debugName: "clickCount" }] : []);
  handleClick() {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && i0.\u0275setClassDebugInfo(AppComponent, { className: "AppComponent", filePath: "projects/events/src/app/app.component.ts", lineNumber: 16 });
})();

export {
  AppComponent
};
//# sourceMappingURL=chunk-XI7GF6FV.js.map
